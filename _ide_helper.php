...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function chargeViaCardToken($cardToken, $merchantRefNum, $user, $currency, $amount, $cvv, $itemId, $description = null)
        {
                        /** @var \Maherelgamil\LaravelFawry\Fawry $instance */
                        return $instance->chargeViaCardToken($cardToken, $merchantRefNum, $user, $currency, $amount, $cvv, $itemId, $description);
        }
                    /**
         * 
         *
